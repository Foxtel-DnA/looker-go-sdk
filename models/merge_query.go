...
func (m *MergeQuery) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateResultMakerID(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSourceQueries(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *MergeQuery) contextValidateCan(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *MergeQuery) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MergeQuery) contextValidateResultMakerID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "result_maker_id", "body", int64(m.ResultMakerID)); err != nil {
		return err
	}
...
func (m *MergeQuery) contextValidateSourceQueries(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.SourceQueries); i++ {

		if m.SourceQueries[i] != nil {
			if err := m.SourceQueries[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("source_queries" + "." + strconv.Itoa(i))
				}
				return err

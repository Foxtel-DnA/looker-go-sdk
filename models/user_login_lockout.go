...
func (m *UserLoginLockout) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateFailCount(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateLockoutAt(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateRemoteID(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *UserLoginLockout) contextValidateAuthType(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "auth_type", "body", string(m.AuthType)); err != nil {
		return err
	}
...
func (m *UserLoginLockout) contextValidateCan(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *UserLoginLockout) contextValidateEmail(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserLoginLockout) contextValidateFailCount(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "fail_count", "body", int64(m.FailCount)); err != nil {
		return err
	}
...
func (m *UserLoginLockout) contextValidateFullName(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "full_name", "body", string(m.FullName)); err != nil {
		return err
	}
...
func (m *UserLoginLockout) contextValidateIP(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserLoginLockout) contextValidateKey(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserLoginLockout) contextValidateLockoutAt(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "lockout_at", "body", strfmt.DateTime(m.LockoutAt)); err != nil {
		return err
	}
...
func (m *UserLoginLockout) contextValidateRemoteID(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "remote_id", "body", string(m.RemoteID)); err != nil {
		return err
	}
...
func (m *UserLoginLockout) contextValidateUserID(ctx context.Context, formats strfmt.Registry) error {

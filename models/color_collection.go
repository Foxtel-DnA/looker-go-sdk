...
func (m *ColorCollection) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateCategoricalPalettes(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateDivergingPalettes(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateSequentialPalettes(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ColorCollection) contextValidateCategoricalPalettes(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.CategoricalPalettes); i++ {

		if m.CategoricalPalettes[i] != nil {
			if err := m.CategoricalPalettes[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("categoricalPalettes" + "." + strconv.Itoa(i))
				}
				return err
...
func (m *ColorCollection) contextValidateDivergingPalettes(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.DivergingPalettes); i++ {

		if m.DivergingPalettes[i] != nil {
			if err := m.DivergingPalettes[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("divergingPalettes" + "." + strconv.Itoa(i))
				}
				return err
...
func (m *ColorCollection) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ColorCollection) contextValidateSequentialPalettes(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.SequentialPalettes); i++ {

		if m.SequentialPalettes[i] != nil {
			if err := m.SequentialPalettes[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("sequentialPalettes" + "." + strconv.Itoa(i))
				}
				return err

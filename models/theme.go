...
func (m *Theme) contextValidateCan(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Theme) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {

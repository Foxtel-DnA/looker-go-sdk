...
func (m *Homepage) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateHomepageSections(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidatePrimaryHomepage(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Homepage) contextValidateCan(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *Homepage) contextValidateContentMetadataID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Homepage) contextValidateCreatedAt(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Homepage) contextValidateHomepageSections(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "homepage_sections", "body", []*HomepageSection(m.HomepageSections)); err != nil {
		return err
	}
	...
	for i := 0; i < len(m.HomepageSections); i++ {
		...
		if m.HomepageSections[i] != nil {
			if err := m.HomepageSections[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("homepage_sections" + "." + strconv.Itoa(i))
				}
				return err
...
func (m *Homepage) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Homepage) contextValidatePrimaryHomepage(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "primary_homepage", "body", m.PrimaryHomepage); err != nil {
		return err
	}
...
func (m *Homepage) contextValidateUpdatedAt(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Homepage) contextValidateUserID(ctx context.Context, formats strfmt.Registry) error {

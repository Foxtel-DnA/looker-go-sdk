...
// NewSearchPermissionSetsParams creates a new SearchPermissionSetsParams object,
...
func NewSearchPermissionSetsParams() *SearchPermissionSetsParams {
	return &SearchPermissionSetsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewSearchPermissionSetsParamsWithTimeout creates a new SearchPermissionSetsParams object
...
// NewSearchPermissionSetsParamsWithContext creates a new SearchPermissionSetsParams object
...
// NewSearchPermissionSetsParamsWithHTTPClient creates a new SearchPermissionSetsParams object
...
func (o *SearchPermissionSetsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.AllAccess != nil {
		...
		// query param all_access
		var qrAllAccess bool

		if o.AllAccess != nil {
			qrAllAccess = *o.AllAccess
		}
		qAllAccess := swag.FormatBool(qrAllAccess)
		if qAllAccess != "" {

			if err := r.SetQueryParam("all_access", qAllAccess); err != nil {
				return err
			}
		}
	}

...
func (o *DeleteRepositoryCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewDeleteRepositoryCredentialTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewDeleteRepositoryCredentialTooManyRequests() *DeleteRepositoryCredentialTooManyRequests {
	return &DeleteRepositoryCredentialTooManyRequests{}
}
...
func (o *DeleteRepositoryCredentialTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /projects/{root_project_id}/credential/{credential_id}][%d] deleteRepositoryCredentialTooManyRequests  %+v", 429, o.Payload)
}
func (o *DeleteRepositoryCredentialTooManyRequests) GetPayload() *models.Error {
	return o.Payload
}

func (o *DeleteRepositoryCredentialTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
func (o *UpdateGitBranchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 429:
		result := NewUpdateGitBranchTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewUpdateGitBranchTooManyRequests() *UpdateGitBranchTooManyRequests {
	return &UpdateGitBranchTooManyRequests{}
}
...
func (o *UpdateGitBranchTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /projects/{project_id}/git_branch][%d] updateGitBranchTooManyRequests  %+v", 429, o.Payload)
}
func (o *UpdateGitBranchTooManyRequests) GetPayload() *models.Error {
	return o.Payload
}

func (o *UpdateGitBranchTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

...
// NewDeployRefToProductionParams creates a new DeployRefToProductionParams object,
...
func NewDeployRefToProductionParams() *DeployRefToProductionParams {
	return &DeployRefToProductionParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDeployRefToProductionParamsWithTimeout creates a new DeployRefToProductionParams object
...
// NewDeployRefToProductionParamsWithContext creates a new DeployRefToProductionParams object
...
// NewDeployRefToProductionParamsWithHTTPClient creates a new DeployRefToProductionParams object
...
func (o *DeployRefToProductionParams) WithDefaults() *DeployRefToProductionParams {
	o.SetDefaults()
	return o
}
...
func (o *DeployRefToProductionParams) WithTimeout(timeout time.Duration) *DeployRefToProductionParams {
...
func (o *DeployRefToProductionParams) WithContext(ctx context.Context) *DeployRefToProductionParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeployRefToProductionParams) WithHTTPClient(client *http.Client) *DeployRefToProductionParams {
...
func (o *DeployRefToProductionParams) WithBranch(branch *string) *DeployRefToProductionParams {
	o.SetBranch(branch)
	return o
}
...
func (o *DeployRefToProductionParams) WithRef(ref *string) *DeployRefToProductionParams {
	o.SetRef(ref)
	return o
}
...
func (o *DeployRefToProductionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {

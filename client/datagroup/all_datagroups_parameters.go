...
/* AllDatagroupsParams contains all the parameters to send to the API endpoint
   for the all datagroups operation.
...
// WithDefaults hydrates default values in the all datagroups params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AllDatagroupsParams) WithDefaults() *AllDatagroupsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the all datagroups params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AllDatagroupsParams) SetDefaults() {

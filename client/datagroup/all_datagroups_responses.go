...
/* AllDatagroupsOK describes a response with status code 200, with default header values.
...
/* AllDatagroupsBadRequest describes a response with status code 400, with default header values.
...
/* AllDatagroupsNotFound describes a response with status code 404, with default header values.

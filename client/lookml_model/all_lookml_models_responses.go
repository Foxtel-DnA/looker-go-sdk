...
/* AllLookmlModelsOK describes a response with status code 200, with default header values.
...
/* AllLookmlModelsBadRequest describes a response with status code 400, with default header values.
...
/* AllLookmlModelsNotFound describes a response with status code 404, with default header values.

...
/* LookmlModelParams contains all the parameters to send to the API endpoint
   for the lookml model operation.
...
// WithDefaults hydrates default values in the lookml model params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LookmlModelParams) WithDefaults() *LookmlModelParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the lookml model params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LookmlModelParams) SetDefaults() {

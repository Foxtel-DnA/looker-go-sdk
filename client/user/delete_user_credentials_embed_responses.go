...
func (o *DeleteUserCredentialsEmbedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	case 429:
		result := NewDeleteUserCredentialsEmbedTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
/* DeleteUserCredentialsEmbedNoContent describes a response with status code 204, with default header values.
...
/* DeleteUserCredentialsEmbedBadRequest describes a response with status code 400, with default header values.
...
/* DeleteUserCredentialsEmbedNotFound describes a response with status code 404, with default header values.
...
// NewDeleteUserCredentialsEmbedTooManyRequests creates a DeleteUserCredentialsEmbedTooManyRequests with default headers values
func NewDeleteUserCredentialsEmbedTooManyRequests() *DeleteUserCredentialsEmbedTooManyRequests {
	return &DeleteUserCredentialsEmbedTooManyRequests{}
}

/* DeleteUserCredentialsEmbedTooManyRequests describes a response with status code 429, with default header values.

Too Many Requests
*/
type DeleteUserCredentialsEmbedTooManyRequests struct {
	Payload *models.Error
}

func (o *DeleteUserCredentialsEmbedTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /users/{user_id}/credentials_embed/{credentials_embed_id}][%d] deleteUserCredentialsEmbedTooManyRequests  %+v", 429, o.Payload)
}
func (o *DeleteUserCredentialsEmbedTooManyRequests) GetPayload() *models.Error {
	return o.Payload
}

func (o *DeleteUserCredentialsEmbedTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

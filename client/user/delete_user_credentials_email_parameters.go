...
/* DeleteUserCredentialsEmailParams contains all the parameters to send to the API endpoint
   for the delete user credentials email operation.
...
// WithDefaults hydrates default values in the delete user credentials email params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteUserCredentialsEmailParams) WithDefaults() *DeleteUserCredentialsEmailParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete user credentials email params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteUserCredentialsEmailParams) SetDefaults() {

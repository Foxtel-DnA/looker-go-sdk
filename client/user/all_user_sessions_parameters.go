...
/* AllUserSessionsParams contains all the parameters to send to the API endpoint
   for the all user sessions operation.
...
// WithDefaults hydrates default values in the all user sessions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AllUserSessionsParams) WithDefaults() *AllUserSessionsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the all user sessions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AllUserSessionsParams) SetDefaults() {

...
/* UserForCredentialOK describes a response with status code 200, with default header values.
...
/* UserForCredentialBadRequest describes a response with status code 400, with default header values.
...
/* UserForCredentialNotFound describes a response with status code 404, with default header values.

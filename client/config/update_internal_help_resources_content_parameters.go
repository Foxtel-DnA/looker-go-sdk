...
func (o *UpdateInternalHelpResourcesContentParams) WithDefaults() *UpdateInternalHelpResourcesContentParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *UpdateInternalHelpResourcesContentParams) SetDefaults() {

...
func (o *CreateLookRenderTaskReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 429:
		result := NewCreateLookRenderTaskTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewCreateLookRenderTaskTooManyRequests() *CreateLookRenderTaskTooManyRequests {
	return &CreateLookRenderTaskTooManyRequests{}
}
...
func (o *CreateLookRenderTaskTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /render_tasks/looks/{look_id}/{result_format}][%d] createLookRenderTaskTooManyRequests  %+v", 429, o.Payload)
}
func (o *CreateLookRenderTaskTooManyRequests) GetPayload() *models.Error {
	return o.Payload
}

func (o *CreateLookRenderTaskTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

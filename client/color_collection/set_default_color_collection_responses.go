...
func (o *SetDefaultColorCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 429:
		result := NewSetDefaultColorCollectionTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewSetDefaultColorCollectionTooManyRequests() *SetDefaultColorCollectionTooManyRequests {
	return &SetDefaultColorCollectionTooManyRequests{}
}
...
func (o *SetDefaultColorCollectionTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /color_collections/default][%d] setDefaultColorCollectionTooManyRequests  %+v", 429, o.Payload)
}
func (o *SetDefaultColorCollectionTooManyRequests) GetPayload() *models.Error {
	return o.Payload
}

func (o *SetDefaultColorCollectionTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

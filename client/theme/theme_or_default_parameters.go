...
/* ThemeOrDefaultParams contains all the parameters to send to the API endpoint
   for the theme or default operation.
...
// WithDefaults hydrates default values in the theme or default params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ThemeOrDefaultParams) WithDefaults() *ThemeOrDefaultParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the theme or default params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ThemeOrDefaultParams) SetDefaults() {

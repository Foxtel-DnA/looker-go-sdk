...
/* DefaultThemeParams contains all the parameters to send to the API endpoint
   for the default theme operation.
...
// WithDefaults hydrates default values in the default theme params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DefaultThemeParams) WithDefaults() *DefaultThemeParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the default theme params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DefaultThemeParams) SetDefaults() {

...
/* ThemeOK describes a response with status code 200, with default header values.
...
/* ThemeBadRequest describes a response with status code 400, with default header values.
...
/* ThemeNotFound describes a response with status code 404, with default header values.

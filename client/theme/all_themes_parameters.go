...
// WithDefaults hydrates default values in the all themes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AllThemesParams) WithDefaults() *AllThemesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the all themes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AllThemesParams) SetDefaults() {

...
/* ActiveThemesParams contains all the parameters to send to the API endpoint
   for the active themes operation.
...
// WithDefaults hydrates default values in the active themes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ActiveThemesParams) WithDefaults() *ActiveThemesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the active themes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ActiveThemesParams) SetDefaults() {

...
/* SearchThemesOK describes a response with status code 200, with default header values.
...
/* SearchThemesBadRequest describes a response with status code 400, with default header values.
...
/* SearchThemesNotFound describes a response with status code 404, with default header values.

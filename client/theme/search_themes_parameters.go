...
/* SearchThemesParams contains all the parameters to send to the API endpoint
   for the search themes operation.
...
// WithDefaults hydrates default values in the search themes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SearchThemesParams) WithDefaults() *SearchThemesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the search themes params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SearchThemesParams) SetDefaults() {

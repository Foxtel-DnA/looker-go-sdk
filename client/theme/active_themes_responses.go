...
/* ActiveThemesOK describes a response with status code 200, with default header values.
...
/* ActiveThemesBadRequest describes a response with status code 400, with default header values.
...
/* ActiveThemesNotFound describes a response with status code 404, with default header values.

...
func (o *CreateDashboardFilterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	case 429:
		result := NewCreateDashboardFilterTooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewCreateDashboardFilterTooManyRequests() *CreateDashboardFilterTooManyRequests {
	return &CreateDashboardFilterTooManyRequests{}
}
...
func (o *CreateDashboardFilterTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /dashboard_filters][%d] createDashboardFilterTooManyRequests  %+v", 429, o.Payload)
}
func (o *CreateDashboardFilterTooManyRequests) GetPayload() *models.Error {
	return o.Payload
}

func (o *CreateDashboardFilterTooManyRequests) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
